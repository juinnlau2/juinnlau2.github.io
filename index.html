...
<body>
    ...
    <nav id="navbar" class="black navbar navbar-expand-lg fixed-top">
        <!-- Brand -->
        <a id="nav-logo" class="navbar-brand" href="index.html">Juinn's Portfolio</a>
            ...
            <div class="row">
                <div class="col text-center">
                    <div class="primary-heading">
                        I'am <span class="fw-bold primary-heading-bold">Lau Jia Juinn</span>
                    </div>
                    <div class="paragraph mx-auto mt-2">
                        A passionate software engineer who enjoys exploring scripting. My current career goal is to develop in the direction of the MPRN stack (MongoDB, Python (FASTAPI), React, Node.js). 
                    </div>
            ...
            <div class="row section-3-inner">
                <div class="col-lg-6 section-3-inner-col-left text-center">
                    <div class="primary-heading section-3-heading text-lg-end">
                        My 
                        <span class="fw-bold">Portfolio</span> Website
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-4-left text-center text-lg-end pe-0 pe-lg-5">
                        ...
                        <span class="section-4-heading-bold fw-bolder">Software</span>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="section-4-right text-center text-lg-start">
                        ...
                        <div class="sec4-text">
                            Feel free to reach out if you're interested in developing software. I can create mobile apps, web applications, and web systems. Additionally, I offer Python scripting services, including custom web scraping scripts and website automation tools (using Selenium or HTTP-based requests, depending on the website's security). I also specialize in building customized Discord autostore bots to help manage your products.
                        </div>
        ...
        <section id="my-portfolio" class="container-fluid section-5">
            ...
            <div class="row mt-4 mt-md-5 work-gallery-row">
                <div class="masonry">
                    <!-- Work 1 -->
                    <div class="grid">
                        <img src="./images/communityIcon_qdbg6bz0bud71.png" class="img-fluid image-work">
                        <div class="grid__body">
                            <div class="relative">
                                <a class="grid__link" target="_blank" href="#"></a>
                                <p class="grid__author">Python App + RESTFUL</p>
                            </div>
                            <div class="mt-auto">
                                <span class="grid__tag">#AutoStore Bots</span>
                            </div>
                        </div>
                    </div>
                    <!-- Work 2 -->
                    <div class="grid">
                        <img src="./images/d9d498fd-b0ce-49af-91a5-3fcae4680514_1600x1046.png" class="img-fluid image-work">
                        <div class="grid__body">
                            <div class="relative">
                                <a class="grid__link" target="_blank" href="#"></a>
                                <p class="grid__author">Python App</p>
                            </div>
                            <div class="mt-auto">
                                <span class="grid__tag">#HTTP BOT</span>
                            </div>
                        </div>
                    </div>
                    <!-- Work 3 -->
                    <div class="grid">
                        <img src="./images/account_generator.jpg" class="img-fluid image-work">
                        <div class="grid__body">
                            <div class="relative">
                                <a class="grid__link" target="_blank" href="#"></a>
                                <p class="grid__author">Python App</p>
                            ...
                            <div class="mt-auto">
                                <span class="grid__tag">#Web Account Generator</span>
                            </div>
                        </div>
                    </div>
                    <!-- Work 4 -->
                    <div class="grid">
                        <img src="./images/money_exchange.png" class="img-fluid image-work">
                        <div class="grid__body">
                            <div class="relative">
                                <a class="grid__link" target="_blank" href="#"></a>
                                <p class="grid__author">React Native</p>
                            </div>
                            <div class="mt-auto">
                                <span class="grid__tag">#Money Exchange App [UNI FYP] </span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="card text-center custom-card mt-5 mt-md-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-para"><a class="card-link" href="https://wa.me/+60xxxxxxxxxx">+60xxx
                                    xxxxxxx</div></a>
                        </div>
                        <!-- <div class="card-footer"></div> -->
                    </div>
                    ...
                    <div class="card text-center custom-card mt-5 mt-lg-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-para"><a class="card-link"
                                    href="mailto:juinnlau@gmail.com">juinnlau@gmail.com</div></a>
                        </div>
                        <!-- <div class="card-footer"></div> -->
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="card text-center custom-card mt-5 mt-lg-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-para"><a class="card-link" target = "_blank" href="https://juinnlau2.github.io/">juinnlau2.github.io</a></div>
                        </div>
                        <!-- <div class="card-footer"></div> -->
                    </div>
                </div>
